...
contract Coupon is Ownable, KIP37, KIP37Burnable, KIP37Mintable {
    using SafeMath for uint256;

    constructor()
        public
        KIP37("https://api.klaychicken.com/guseul/meta/{id}.json")
    {}

    string public baseURI = "https://api.klaychicken.com/guseul/meta/";
